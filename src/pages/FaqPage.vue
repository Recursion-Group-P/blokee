  ...
  <q-page padding>
    <div class="q-pa-md">
      <div class="q-gutter-y-md">
        <q-tabs v-model="tab" narrow-indicator dense align="justify" class="text-indigo-10" style="max-width: 400px">
        ...
        <q-tab-panels v-model="tab" animated>
          ...
          <q-tab-panel name="faq">
            <div class="q-pa-sm" v-for="f in faq" :key="f.faqId">
              <q-expansion-item class="shadow-1 overflow-hidden" style="border-radius: 4px" icon="help"
                :label="f.question" header-class="bg-indigo-10 text-white" expand-icon-class="text-white">
                <q-card>
                  <q-card-section>
                    {{ f.answer }}
                  </q-card-section>
